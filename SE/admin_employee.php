									...
									<tbody>
										...
										<tr>
											...
											<?php
												...
												$query= mysql_query("SELECT uid,GROUP_CONCAT(skill) as skill, GROUP_CONCAT(experience) as experience FROM skill WHERE uid= '$id' GROUP BY uid" ) or die (mysql_error());
