				...
				<div class="tab-content">
					<div id="Signup" class="tab-pane fade in active">
						<div class="innter-form">
							<form class="form-horizontal" name="reg" action="signup.php" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<div class="col-md-12">
										<input type="text" maxlength="12"  pattern="[0-9]{12}" class="form-control" id="aadhar" name="aadhar" placeholder="Aadhar Number" required/>
									</div>
								</div>
                                                                <div class="form-group">
									<div class="col-md-12">
										<input type="text" maxlength="10"  pattern="[0-9]{10}" class="form-control" id="number" name="number" placeholder="Contact Number" required/>
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-12">
